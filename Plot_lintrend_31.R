...
birth_data_grouped$age_group <- cut(birth_data_grouped$`age.of.the.Mother`,
                                    breaks = c(15, 20, 31, Inf),
                                    labels = c("15-19", "20-30", "31+"),
                                    right = FALSE)
...
actual_colors <- c("15-19, Actual" = "blue", "20-30, Actual" = "green", "31+, Actual" = "red")
trend_colors <- c("15-19, Trend" = "lightblue", "20-30, Trend" = "lightgreen", "31+, Trend" = "pink")
